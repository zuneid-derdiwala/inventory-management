-- Add user_id column to tables if it doesn't exist, set it to NOT NULL with DEFAULT auth.uid(), and add foreign key constraint
DO $$
BEGIN
    -- entries table
    ...
    ALTER TABLE public.entries ADD CONSTRAINT fk_entries_user_id FOREIGN KEY (user_id) REFERENCES auth.users ON DELETE CASCADE;
    ...
    ALTER TABLE public.brands ADD CONSTRAINT fk_brands_user_id FOREIGN KEY (user_id) REFERENCES auth.users ON DELETE CASCADE;
    ...
    ALTER TABLE public.models ADD CONSTRAINT fk_models_user_id FOREIGN KEY (user_id) REFERENCES auth.users ON DELETE CASCADE;
    ...
    ALTER TABLE public.sellers ADD CONSTRAINT fk_sellers_user_id FOREIGN KEY (user_id) REFERENCES auth.users ON DELETE CASCADE;
    CREATE INDEX IF NOT EXISTS sellers_user_id_idx ON public.sellers (user_id);

    -- booking_persons table
    ...
    ALTER TABLE public.booking_persons ADD CONSTRAINT fk_booking_persons_user_id FOREIGN KEY (user_id) REFERENCES auth.users ON DELETE CASCADE;
